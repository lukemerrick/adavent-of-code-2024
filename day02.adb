...
procedure Day02 is
   ...
   -- NOTE: This got really hacky to handle skipping. TODO: Write better Ada code!
...
begin
   ...
   for I in Line_Num loop
      Read_Report (Get_Line (F), Report);
      --  Print_Report (Report);
      --  Put_Line (Boolean'Image (Check_Report_Safety (Report)));
